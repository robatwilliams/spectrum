...
const PrivateCommunityRequestSentComponent = ({ notification, currentUser, approvePendingCommunityMember, blockPendingCommunityMember, markSingleNotificationSeen }: Props) => {
