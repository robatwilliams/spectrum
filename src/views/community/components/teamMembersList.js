...
const Component = (props: Props) => {
  ...
  const isOwner = community.communityPermissions.isOwner;
  ...
  const { community: dataCommunity } = data;

  const { edges: members } = dataCommunity.members;
  const nodes = members
      ...
      <SidebarSectionHeader>
        ...
        {isOwner && (
          <Tooltip content={'Manage team'}>
            <span>
              <WhiteIconButton to={`/${dataCommunity.slug}/settings/members`}>
