      ...
      <ContentContainer>
        ...
        <Section>
          ...
          <SectionDescription>
            ...
            investing in deeper integrations with the GitHub ecosystem. For this
            reason, new Spectrum accounts must be connected to a GitHub profile.
            In the future this will help us associate community posts with your
            code, projects, and collaborators on GitHub.
          </SectionDescription>
        </Section>
        ...
        <Section>
          ...
          <PrivacyTermsList>
            <li>
              ...
              database. This includes your name, username, profile photo, cover
              photo, description, and any connections to 3rd party social
              networks (that you use to sign in to Spectrum).
            </li>
            <li>
          ...
          <SectionDescription>
            ...
            deleted, in order to preserve the integrity of the public nature of
            discussions on Spectrum. Any messages or conversations that remain
