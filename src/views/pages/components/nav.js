...
const Nav = (props: Props) => {
  ...
  return (
    <NavContainer data-cy="navigation-splash">
      ...
      <Tabs>
        <LogoTab dark={dark} to="/about" data-cy="navigation-splash-about">
          <Logo />
          <Icon glyph={'logo'} />
        </LogoTab>
        <FeaturesTab
        ...
        <MenuTab dark={dark} open={menuIsOpen}>
          ...
          <MenuContainer open={menuIsOpen}>
            ...
            <FeaturesLink to="/features" selected={location === 'features'}>
              Features
            </FeaturesLink>
            <AppsLink to="/apps" selected={location === 'apps'}>
              Apps
            </AppsLink>
            <SupportLink to="/support" selected={location === 'support'}>
              Support
            </SupportLink>
            <ExploreLink to="/explore" selected={location === 'explore'}>
              Explore
            </ExploreLink>
            {currentUser ? (
              <AuthLink to={'/'}>
          ...
          <MenuOverlay onClick={() => toggleMenu()} open={menuIsOpen} />
        </MenuTab>
      </Tabs>
    </NavContainer>
  );
