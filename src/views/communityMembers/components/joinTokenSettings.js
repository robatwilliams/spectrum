...
const JoinTokenSettings = (props: Props) => {
  const {
    data: { community },
    isLoading,
    dispatch,
  ...
  if (community) {
    ...
    return (
      <SectionCard data-cy="login-with-token-settings">
        ...
        <SectionSubtitle>
          Allow people to join this private community by visiting a unique link.
        ...
        {joinSettings.tokenJoinEnabled && <ResetJoinToken id={community.id} />}
      </SectionCard>
    );
  }
