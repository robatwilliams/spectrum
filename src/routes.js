...
const UserView = Loadable({
  loader: () => import('./views/user/index.tsx'/* webpackChunkName: "UserView" */),
  loading: ({ isLoading }) => isLoading && <LoadingView />,
});
...
const ChannelView = Loadable({
  loader: () => import('./views/channel/index.tsx'/* webpackChunkName: "ChannelView" */),
  loading: ({ isLoading }) => isLoading && <LoadingView />,
});
...
const UserSettings = Loadable({
  loader: () => import('./views/userSettings/index.tsx'/* webpackChunkName: "UserSettings" */),
  loading: ({ isLoading }) => isLoading && <LoadingView />,
});

/* prettier-ignore */
const CommunitySettings = Loadable({
  loader: () => import('./views/communitySettings/index.tsx'/* webpackChunkName: "communitySettings" */),
  loading: ({ isLoading }) => isLoading && <LoadingView />,
});

/* prettier-ignore */
const ChannelSettings = Loadable({
  loader: () => import('./views/channelSettings/index.tsx'/* webpackChunkName: "channelSettings" */),
  loading: ({ isLoading }) => isLoading && <LoadingView />,
});
...
const Search = Loadable({
  loader: () => import('./views/search/index.tsx'/* webpackChunkName: "Search" */),
  loading: ({ isLoading }) => isLoading && <LoadingView />,
});
...
const Routes = (props: Props) => {
  const previousLocationRef = useRef(props.location);
  const [navigationIsOpen, setNavigationIsOpenState] = useState(false);

  const setNavigationIsOpen = (val: boolean) => setNavigationIsOpenState(val);
